...
#if defined(SHADOWS_CUBE) && !defined(SHADOWS_CUBE_IN_DEPTH_TEX) && !defined(VOXEL_SHADOW)
...
#elif defined(VOXEL_SHADOW)

    #define V2F_SHADOW_CASTER_NOPOS float depth : TEXCOORD3;
    #ifdef SHADER_API_D3D11
        #define TRANSFER_SHADOW_CASTER_NOPOS_LEGACY(o,opos) o.depth = o.vertex.z / o.vertex.w; 
        #define TRANSFER_SHADOW_CASTER_NOPOS(o,opos) o.depth = o.vertex.z / o.vertex.w; 
        #define SHADOW_CASTER_FRAGMENT(i) return EncodeFloatRGBA(min(i.depth, 0.999));
    #else
        #define TRANSFER_SHADOW_CASTER_NOPOS_LEGACY(o,opos) o.depth = o.vertex.z / o.vertex.w * 0.5 + 0.5; opos = UnityObjectToClipPos(v.vertex);
        #define TRANSFER_SHADOW_CASTER_NOPOS(o,opos) o.depth = o.vertex.z / o.vertex.w * 0.5 + 0.5; opos = UnityObjectToClipPos(v.vertex);
        #define SHADOW_CASTER_FRAGMENT(i) return EncodeFloatRGBA(min(1- i.depth, 0.999));
    #endif
#else
